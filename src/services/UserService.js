...
export const loginUser = async (data) => {
    const res = await axios.post(`https://ecommerce-backend-dgl7.onrender.com/api/user/sign-in`, data)
    return res.data
}

// đăng ký
export const signupUser = async (data) => {
    const res = await axios.post(`https://ecommerce-backend-dgl7.onrender.com/api/user/sign-up`, data)
    return res.data
}
...
export const getDetailsUser = async (id, access_token) => {
    const res = await axiosJWT.get(`https://ecommerce-backend-dgl7.onrender.com/api/user/get-details/${id}`, {
        headers: {
...
export const refreshToken = async (refreshToken) => {
    ...
    const res = await axios.post(`https://ecommerce-backend-dgl7.onrender.com/api/user/refresh-token`, {}, {
...
export const logoutUser = async () => {
    const res = await axios.post(`https://ecommerce-backend-dgl7.onrender.com/api/user/log-out`)
    return res.data
}
...
export const getAllUser = async (access_token) => {
    const res = await axios.get(`https://ecommerce-backend-dgl7.onrender.com/api/user/getAll`, {
        headers: {
            token: `Brearer ${access_token}`,
        }
    })
...
export const deleteUserMany = async (data, access_token) => {
    const res = await axiosJWT.post(`https://ecommerce-backend-dgl7.onrender.com/api/user/delete-many`, data,  {
        headers: {
            token: `Brearer ${access_token}`,
        }
    })
